...
class UUID(uuid.UUID):
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        if int is None or [hex, bytes, bytes_le, fields].count(None) != 4:  # noqa: PLR2004
            super().__init__(
                hex=hex,
                bytes=bytes,
                bytes_le=bytes_le,
        ...
        if int is not None and version is not None:
            if not 6 <= version <= 7:  # noqa: PLR2004
...
def uuid6(clock_seq: int | None = None) -> UUID:
    ...
    global _last_v6_timestamp  # noqa: PLW0603
...
def uuid7() -> UUID:
    ...
    global _last_v7_timestamp  # noqa: PLW0603
